    ...
    <div className="relative min-h-screen overflow-hidden"> 
      ...
      <div className="relative z-20 min-h-screen flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 style={{ fontFamily: 'Georgia, "Times New Roman", serif' }} className="text-center lg:text-left text-4xl sm:text-5xl md:text-7xl lg:text-[4rem] xl:text-[5.8rem] mb-6 leading-[1.0] font-serif font-normal text-white">
            One Standard.<br />
            Common Ground.
          </h1>
