...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  return (
    <section
      className={`w-full overflow-hidden pt-14 ${bgClassName}`}
    ...
    >
      <svg
        viewBox={isMobile ? "0 40 390 120" : "0 40 1440 180"}
        className="block w-full h-[90px] md:h-[140px] overflow-visible"
