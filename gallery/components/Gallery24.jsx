...
export function Gallery24() {
  const scrollAnim = useRelume(); // ← renamed to avoid collision with imported useScroll
  return (
    <section
      id="relume"
      ref={scrollAnim.transformRef} // ← duplicate ref removed
    >
      ...
      <div className="h-[400vh]">
        <div className="sticky top-0 mt-[-10vh] flex h-screen w-screen max-w-full flex-col items-start justify-center overflow-hidden px-[5%] md:mt-0">
          <motion.div
            style={{ x: scrollAnim.x }} // ← updated reference
